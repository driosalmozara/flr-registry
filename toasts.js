...
(function(){
  ...
  link.rel = 'icon'; link.type = 'image/png'; link.href = 'icono-q.png?v=20260912';
...
(function(){
  ...
  if (!document.querySelector('link[rel="apple-touch-icon"]')) {
    ...
    a.rel = 'apple-touch-icon'; a.href = 'icono-q.png?v=20260912';
...
function notificacionSistema(title, body){
  ...
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.ready.then(function(reg){
      reg.showNotification(title || '♛ Queendomland', { body: body || '', icon: 'icono-q.png', badge: 'icono-q.png' });
    }).catch(function(){});
  }
}
...
(function(){
  ...
  f.innerHTML = '🏛 Créditos — plataforma dirigida a la <b style="color:#c9a24b;">Superioridad Femenina</b> · Contenido simbólico y consensuado entre adultos.';
